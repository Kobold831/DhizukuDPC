...
import static com.afwsamples.dhizukudpc.common.Util.isAtLeastT;
...
public final class DevicePolicyManagerGatewayImpl implements DevicePolicyManagerGateway {
  ...
  public DevicePolicyManagerGatewayImpl(@NonNull Context context) {
    this(
            Objects.requireNonNull(Common.binderWrapperDevicePolicyManager(context)),
  ...
  public static DevicePolicyManagerGatewayImpl forParentProfile(@NonNull Context context) {
    ComponentName admin = DhizukuVariables.COMPONENT_NAME;
  ...
  public void createAndManageUser(
          String name, int flags, @NonNull Consumer<UserHandle> onSuccess, @NonNull Consumer<Exception> onError) {
  ...
  @Override
  public void setUserIcon(@NonNull Bitmap icon, @NonNull Consumer<Void> onSuccess, @NonNull Consumer<Exception> onError) {
  ...
  public void setStartUserSessionMessage(
          CharSequence message, @NonNull Consumer<Void> onSuccess, @NonNull Consumer<Exception> onError) {
  ...
  @Override
  public void removeUser(@NonNull UserHandle userHandle, @NonNull Consumer<Void> onSuccess, @NonNull Consumer<Exception> onError) {
  ...
  @Override
  public void switchUser(UserHandle userHandle, Consumer<Void> onSuccess, Consumer<Exception> onError) {
  ...
  @Override
  public void startUserInBackground(UserHandle userHandle, Consumer<Integer> onSuccess, Consumer<Exception> onError) {
  ...
  @Override
  public void stopUser(UserHandle userHandle, Consumer<Integer> onSuccess, Consumer<Exception> onError) {
  ...
  @Override
  public void setLogoutEnabled(boolean enabled, Consumer<Void> onSuccess, Consumer<Exception> onError) {
  ...
  public void setUserRestriction(String userRestriction, boolean enabled) {
    ...
    setUserRestriction(
            userRestriction, enabled, (v) -> onSuccessLog(message), (e) -> onErrorLog(message, e));
  }
  ...
  public void setNetworkLoggingEnabled(boolean enabled) {
    ...
    setNetworkLoggingEnabled(enabled, (v) -> onSuccessLog(message), (e) -> onErrorLog(message, e));
  }
  ...
  public boolean setPermittedInputMethods(List<String> packageNames) {
    ...
    return setPermittedInputMethods(
            packageNames, (v) -> onSuccessLog(message), (e) -> onErrorLog(message, e));
  }
  ...
  public void setUsbDataSignalingEnabled(boolean enabled) {
    ...
    setUsbDataSignalingEnabled(
            enabled, (v) -> onSuccessLog(message), (e) -> onErrorLog(message, e));
  }
