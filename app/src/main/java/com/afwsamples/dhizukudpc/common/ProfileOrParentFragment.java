...
public abstract class ProfileOrParentFragment extends BaseSearchablePolicyPreferenceFragment {
  ...
  public abstract static class Container extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      FragmentTabHost tabHost = new FragmentTabHost(requireActivity());
      tabHost.setup(requireActivity(), getChildFragmentManager(), container.getId());

      final boolean showDualTabs = Util.isManagedProfileOwner(getActivity()) && Util.SDK_INT >= VERSION_CODES.N;
