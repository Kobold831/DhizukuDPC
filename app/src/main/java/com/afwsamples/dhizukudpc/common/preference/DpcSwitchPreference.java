...
/**
 * An {@link SwitchPreferenceCompat} which can be disabled via XML declared constraints.
 *
 * <p>See {@link DpcPreferenceHelper} for details about constraints.
 */
public class DpcSwitchPreference extends SwitchPreferenceCompat implements DpcPreferenceBase {
