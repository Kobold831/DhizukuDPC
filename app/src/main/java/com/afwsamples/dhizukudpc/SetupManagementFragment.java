...
import com.afwsamples.dhizukudpc.common.LaunchIntentUtil;
import com.afwsamples.dhizukudpc.common.ProvisioningStateUtil;
...
public class SetupManagementFragment extends Fragment implements View.OnClickListener, ColorPicker.OnColorSelectListener, RadioGroup.OnCheckedChangeListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    view.findViewById(R.id.setup_management_button_next).setOnClickListener(this::onNavigateNext);

    view.findViewById(R.id.setup_management_button_exit).setOnClickListener(this::onNavigateBack);

    button = view.findViewById(R.id.setup_management_button_next);
  ...
  public void onClick(View view) {
    ...
    if (id == R.id.params_indicator) {
      ...
      ColorPicker.newInstance(mCurrentColor, FRAGMENT_TAG, "provisioningColor").show(requireActivity().getSupportFragmentManager(), "colorPicker");
