...
package com.afwsamples.dhizukudpc.transferownership;
...
public class PickTransferComponentFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    final ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.transfer_ownership_dialog, container, false);
    ...
    final ListAdapter adapter =
        new ArrayAdapter<>(requireActivity(), android.R.layout.simple_list_item_1, items);
  ...
  private String performTransfer(ComponentName target) {
    ComponentName source = DhizukuVariables.COMPONENT_NAME;
