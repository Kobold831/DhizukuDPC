...
public class WifiConfigCreationDialog extends DialogFragment implements AdapterView.OnItemSelectedListener, View.OnClickListener, TextWatcher {
  ...
  public static WifiConfigCreationDialog newInstance(WifiConfiguration oldConfig, Listener listener) {
    WifiConfigCreationDialog dialog = new WifiConfigCreationDialog();
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    ArrayAdapter<CharSequence> adapter =
        ArrayAdapter.createFromResource(
            requireActivity(), R.array.wifi_security_choices, android.R.layout.simple_spinner_item);
  ...
  public void onStart() {
    super.onStart();
    mAlertDialog = (AlertDialog) requireDialog();
  ...
  public void onClick(View view) {
    if (view == mSaveButton) {
      ...
      boolean success = WifiConfigUtil.saveWifiConfiguration(requireActivity(), config);
  ...
  private void updateConfigurationSecurity(WifiConfiguration config) {
    switch (mSecurityType) {
      case SECURITY_TYPE_NONE -> config.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
