...
import com.afwsamples.dhizukudpc.common.BaseManageComponentFragment;
...
public abstract class BaseStringItemsFragment extends BaseManageComponentFragment<Void>
  ...
  public void onResume() {
    super.onResume();
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(mFragmentTitleResId);
  }
