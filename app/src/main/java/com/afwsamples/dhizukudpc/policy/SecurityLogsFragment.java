...
public class SecurityLogsFragment extends ListFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mAdminName = DhizukuVariables.COMPONENT_NAME;
    mDevicePolicyManager = Common.binderWrapperDevicePolicyManager(requireActivity());
    mAdapter =
        new ArrayAdapter<>(
            requireActivity(), android.R.layout.simple_list_item_1, android.R.id.text1, mLogs);
    mPreReboot = requireArguments().getBoolean(PRE_REBOOT_KEY);
  ...
  private boolean hasSecurityLoggingDelegation() {
    ...
    final String packageName = DhizukuVariables.PACKAGE_NAME;
