...
package com.afwsamples.dhizukudpc.policy.systemupdatepolicy;
...
public class SystemUpdatePolicyFragment extends Fragment
  ...
  public void onResume() {
    super.onResume();
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.system_update_policy);
  ...
  private void promptToSetFreezePeriod(
    ...
    showDatePicker(
        ...
        pickedStartDate -> {
          ...
          if (proposedEndDate.isBefore(pickedStartDate)) {
  ...
  private boolean setSystemUpdatePolicy() {
    ...
    try {
      ...
      mDpm.setSystemUpdatePolicy(DhizukuVariables.COMPONENT_NAME, newPolicy);
