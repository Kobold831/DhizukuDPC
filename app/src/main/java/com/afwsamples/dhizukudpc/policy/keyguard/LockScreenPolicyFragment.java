...
import static com.afwsamples.dhizukudpc.policy.keyguard.SetTrustAgentConfigFragment.Type;
...
import com.afwsamples.dhizukudpc.common.ProfileOrParentFragment;
...
public final class LockScreenPolicyFragment extends ProfileOrParentFragment
  ...
  public void onCreate(Bundle savedInstanceState) {
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.lock_screen_policy);
