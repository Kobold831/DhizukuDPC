...
package com.afwsamples.dhizukudpc.policy.locktask;
...
public class SetLockTaskFeaturesFragment extends BaseSearchablePolicyPreferenceFragment implements Preference.OnPreferenceChangeListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    mDpmGateway = new DevicePolicyManagerGatewayImpl(requireActivity());

    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.set_lock_task_features_title);
