...
package com.afwsamples.dhizukudpc.policy.wifimanagement;
...
public class WifiModificationFragment extends Fragment implements WifiConfigCreationDialog.Listener {
  ...
  private class ConfigsAdapter extends ArrayAdapter<WifiConfiguration> {
    public ConfigsAdapter() {
      super(requireActivity(), android.R.layout.simple_list_item_checked, mConfiguredNetworks);
    }
  ...
  public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
    ...
    mShowOwnedNetworksOnly = requireArguments().getBoolean(ARG_OWNED_NETWORKS_ONLY);
    mWifiManager = requireActivity().getSystemService(WifiManager.class);
      ...
      updateConfigButton.setOnClickListener(v -> {
        ...
        try {
          ...
          if (oldConf.enterpriseConfig == null
            ...
            dialog = WifiConfigCreationDialog.newInstance(oldConf, WifiModificationFragment.this);
          } else {
            dialog = WifiEapTlsCreateDialogFragment.newInstance(oldConf);
          }
          dialog.show(requireActivity().getSupportFragmentManager(), TAG_WIFI_CONFIG_MODIFICATION);
