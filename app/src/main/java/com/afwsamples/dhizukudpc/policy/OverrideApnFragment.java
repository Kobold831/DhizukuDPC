...
public class OverrideApnFragment extends BaseSearchablePolicyPreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
  ...
  private SwitchPreferenceCompat mEnableOverrideApnPreference;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.override_apn_title);
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    mEnableOverrideApnPreference = (SwitchPreferenceCompat) findPreference(ENABLE_OVERRIDE_APN_KEY);
  ...
  void setUpSpinner(View dialogView, int viewId, int textArrayId) {
    ...
    final ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(requireActivity(), textArrayId, android.R.layout.simple_spinner_item);
  ...
  void showInsertOverrideApnDialog() {
    ...
    final View dialogView = requireActivity().getLayoutInflater().inflate(R.layout.insert_apn, null);
