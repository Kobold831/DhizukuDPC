...
public class SetUserSessionMessageFragment extends Fragment implements View.OnClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.set_user_session_message);
    mDevicePolicyManager = Common.binderWrapperDevicePolicyManager(requireActivity());
    mComponentName = DhizukuVariables.COMPONENT_NAME;
  }
