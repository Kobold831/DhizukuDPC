...
package com.afwsamples.dhizukudpc.cosu;
 ...
 */
public class EnableCosuActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    DevicePolicyManager dpm = Common.binderWrapperDevicePolicyManager(this);
    if (!dpm.isDeviceOwnerApp(DhizukuVariables.PACKAGE_NAME)) {
