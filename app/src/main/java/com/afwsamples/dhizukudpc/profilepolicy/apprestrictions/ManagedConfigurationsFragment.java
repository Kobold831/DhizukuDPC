...
import com.afwsamples.dhizukudpc.common.RestrictionManagerCompat;
...
public class ManagedConfigurationsFragment extends ManageAppFragment
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mRestrictionsManager = (RestrictionsManager) requireActivity().getSystemService(Context.RESTRICTIONS_SERVICE);
  }

  @Override
  public void onResume() {
    super.onResume();
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.managed_configurations);
  }
