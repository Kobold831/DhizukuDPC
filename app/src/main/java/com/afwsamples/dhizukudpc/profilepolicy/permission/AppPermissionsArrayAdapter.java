...
package com.afwsamples.dhizukudpc.profilepolicy.permission;
...
public class AppPermissionsArrayAdapter
  ...
  public AppPermissionsArrayAdapter(
    ...
    mDpm = Common.binderWrapperDevicePolicyManager(context);
  ...
  public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
    ...
    mDpm.setPermissionGrantState(mAdminComponentName, appPermission.pkgName, appPermission.permissionName, appPermission.permissionState);
  }
