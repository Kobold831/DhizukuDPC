...
package com.afwsamples.dhizukudpc.profilepolicy;
...
import com.afwsamples.dhizukudpc.common.ColorPicker;
import com.afwsamples.dhizukudpc.common.Util;
import com.afwsamples.dhizukudpc.profilepolicy.crossprofilewidgetprovider.ManageCrossProfileWidgetProviderUtil;
...
public class ProfilePolicyManagementFragment extends BaseSearchablePolicyPreferenceFragment
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    mAddCrossProfileIntentFilterPreference = findPreference(ADD_CROSS_PROFILE_INTENT_FILTER_PREFERENCE_KEY);
    mAddCrossProfileIntentFilterPreference.setOnPreferenceClickListener(this);
    mClearCrossProfileIntentFiltersPreference = findPreference(CLEAR_CROSS_PROFILE_INTENT_FILTERS_PREFERENCE_KEY);
  ...
  public void onResume() {
    super.onResume();
    Objects.requireNonNull(((AppCompatActivity) requireActivity()).getSupportActionBar()).setTitle(R.string.profile_management_title);
  ...
  public boolean onPreferenceClick(Preference preference) {
    ...
    switch (key) {
      ...
      case SET_ORGANIZATION_COLOR_KEY -> {
        int colorValue = requireActivity().getResources().getColor(R.color.teal);
      ...
      case MANAGED_SUBSCRIPTIONS_KEY -> showManagedSubscriptionsPolicyDialog();
    }
    return false;
  }
  ...
  private void showDisabledAppWidgetList() {
    ...
    if (disabledCrossProfileWidgetProvidersList.isEmpty()) {
      ...
      AppInfoArrayAdapter appInfoArrayAdapter = new AppInfoArrayAdapter(requireActivity(), R.layout.app_row, disabledCrossProfileWidgetProvidersList);
      MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(requireActivity());
      builder.setTitle(getString(R.string.add_cross_profile_app_widget_providers_title));
      builder.setAdapter(appInfoArrayAdapter, (dialog, which) -> {
  ...
  private void showEnabledAppWidgetList() {
    ...
    if (enabledCrossProfileWidgetProvidersList.isEmpty()) {
      ...
      AppInfoArrayAdapter appInfoArrayAdapter = new AppInfoArrayAdapter(requireActivity(), R.layout.app_row, enabledCrossProfileWidgetProvidersList);
      MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(requireActivity());
  ...
  private void showToast(int msgId) {
    ...
    Toast.makeText(requireActivity(), msgId, Toast.LENGTH_SHORT).show();
  }
  ...
  private void showManagedSubscriptionsPolicyDialog() {
    ...
    View policyView =
        requireActivity().getLayoutInflater().inflate(R.layout.managed_subscriptions_policy, null);
