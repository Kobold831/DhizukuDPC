...
package com.afwsamples.dhizukudpc.provision;

import static android.app.admin.DevicePolicyManager.EXTRA_PROVISIONING_ADMIN_EXTRAS_BUNDLE;
import static android.app.admin.DevicePolicyManager.PERMISSION_GRANT_STATE_GRANTED;
import static com.afwsamples.dhizukudpc.DeviceAdminReceiver.getComponentName;
...
import com.afwsamples.dhizukudpc.FinalizeActivity;
import com.afwsamples.dhizukudpc.common.LaunchIntentUtil;
import com.afwsamples.dhizukudpc.common.Util;
import com.afwsamples.dhizukudpc.cosu.EnableCosuActivity;
...
public class PostProvisioningTask {
  ...
  public PostProvisioningTask(Context context) {
    mContext = context;
    mDevicePolicyManager = Common.binderWrapperDevicePolicyManager(context);
